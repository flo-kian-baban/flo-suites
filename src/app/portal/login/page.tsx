...
export default function PortalLoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        // Redirect to entry point which handles routing logic
        router.push('/portal');
        router.refresh();
    };
            ...
            <div className="relative w-full max-w-sm">
                ...
                <div className="group relative">
                    ...
                    <div className="relative bg-[#111] border border-white/10 rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
                        ...
                        <p className="text-white/40 text-sm mb-6">Sign in to your portal</p>
                        ...
                        <div className="mt-6 pt-5 border-t border-white/[0.06] text-center">
                            <p className="text-white/40 text-xs">
                                ...
                                <a href="/portal/signup" className="text-flo-orange hover:text-flo-orange-light transition-colors font-medium">
                                    Sign Up
                                </a>
                            </p>
                        </div>
